...
export enum FrontEndListeners {
  addToLibrary = "frequest.add_to_library",
  deleteFromLibrary = "frequest.delete_from_library",
  dumpLibrary = "frequest.dump_library",
  notification = "frequest.notification"
}
